...
# print(data_user.values())
# print(data_user.items())

# #những người giới tính nam và số lượng
# a = list(filter(lambda x : x['gender'] == 'male' , data_user['users']))
# for b in a:
#     print(b)
# print(a.__len__())

#tìm người
# find = list(filter(lambda x : 'ohio' in x['university'].lower(), data_user['users']))
# print(find)


# age = list(filter(lambda x : x['user']['age'] > 30, data_user ))
# print(age)  sai


# def person(n):
#     return n['gender'] == 'male'and n['age'] > 40 and n['height'] > 180
# dap_an = list(filter(person, data_user['users']))
# # print(list(dap_an))
...
'''
Nhập thông tin học sinh (tên, tuổi, lớp, mã số học sinh, ngày sinh)
Lưu trữ toàn bộ học sinh vào cấu trúc list, học sinh lưu bằng dạng dictionary
Chức năng:
- Nhập xuất
- tìm kiếm tên - filter
- lọc theo ngày sinh
...
#     print(list(ds_hs))
#   elif option == 3:
#     item = input("Nhập ngày sinh: ")
#     print(list(filter(lambda item: item in ds_hs["birthday"], ds_hs)))

# for a in range(data_user['users'].__len__()):
#     print(data_user['users'][a]['maidenName'], end= ' ')

# print(data_user['users'][1]['age'])
a = list(filter(lambda x : x['age'] >= 28 , data_user['users']))
count = 0
